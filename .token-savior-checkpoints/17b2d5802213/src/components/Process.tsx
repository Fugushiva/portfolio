...
const STEP_ICONS = [
  (
    <svg key="step-clock" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M10 2a8 8 0 100 16A8 8 0 0010 2zM10 6v4l3 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  ),
  (
    <svg key="step-grid" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
  ...
  (
    <svg key="step-check" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <polyline points="4,10 8,14 16,6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  (
    <svg key="step-star" width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
    ...
    >
      ...
      <div className="max-w-[1600px] grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
        ...
        <div className="flex flex-col justify-center" data-reveal>
          ...
          <p className="text-muted text-base md:text-lg xl:text-[1.15rem] 2xl:text-xl leading-relaxed max-w-[440px] xl:max-w-[520px]">
            {t('subheadline')}
          </p>
